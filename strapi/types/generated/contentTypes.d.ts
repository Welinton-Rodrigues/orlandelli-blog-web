...
export interface ApiIlustraca0Ilustraca0 extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'ilustracao';
    pluralName: 'ilustraca0s';
    singularName: 'ilustraca0';
  };
  options: {
...
export interface ApiQuadrinhoQuadrinho extends Struct.CollectionTypeSchema {
  ...
  info: {
    ...
    pluralName: 'quadrinhos';
    singularName: 'quadrinho';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::quadrinho.quadrinho'
    > &
      Schema.Attribute.Private;
    paginas: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    publishedAt: Schema.Attribute.DateTime;
